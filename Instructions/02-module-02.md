...
1. 在 Azure 机器学习工作室中单击 **“管理预览功能”** （扬声器图标）。

![菜单中“管理预览功能”按钮的屏幕截图。](../instructions/media/use-automated-machine-learning/severless-compute-1.png)

1. 启用“使用无服务器计算提交训练作业的引导式体验”功能。

![启用无服务器计算功能的屏幕截图。](../instructions/media/use-automated-machine-learning/enable-serverless-compute.png)
...
请注意， *“查看其他配置设置”* 是 *限制*部分。 展开该部分以配置设置：
        - **超时（分钟）** ：30 - *最多 30 分钟后结束作业。*
