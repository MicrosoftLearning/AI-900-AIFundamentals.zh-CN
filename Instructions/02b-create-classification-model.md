...
1. 在 [Azure 机器学习工作室](https://ml.azure.com?azure-portal=true)中，通过选择屏幕左上角的菜单图标展开左窗格。 查看“设计器”页面（在“创建者”下），然后选择 + 创建新管道  。
...
1. 单击“数据”。 搜索“diabetes-data”数据集并将其放置在画布上。
...
1. 在 Azure 机器学习工作室中，通过选择屏幕左上角的菜单图标展开左窗格。 单击“作业”（“资产”下）以查看运行的所有作业。 选择试验 mslearn-diabetes-training，然后选择“糖尿病训练”管道 。
